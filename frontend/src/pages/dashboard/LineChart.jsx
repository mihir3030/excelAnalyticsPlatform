...
export default function LineChart() {
  ...
  const handleGenerateChart = () => {
    ...
    if (!numericColumns.includes(selectedYAxis)) {
      setChartError(
        `Warning: "${selectedYAxis}" contains non-numeric data. Results may be inaccurate.`
      );
    }

    const groupedData = groupData(selectedXAxis, selectedYAxis, aggregation);
    const newChartData = generateLineChartData(
      groupedData,
      selectedXAxis,
      selectedYAxis
    );
    ...
    if (!newChartData) {
      setChartError(
        "No valid numeric data found for the selected columns. Please choose different columns."
      );
      return;
    }
      ...
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="bg-white p-8 rounded-xl shadow-lg text-center max-w-md">
          ...
          <p className="text-gray-600 mb-6">
            The requested file data could not be found.
          </p>
          <button
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-gray-800">Line Chart</p>
                    </div>
                    <div>
                      <h4 className="text-sm font-medium text-gray-500">
                        Category Column
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-gray-800">
                        {chartData.labels.length} points
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
              <div className="max-w-md mx-auto">
                ...
                <p className="text-gray-500 mb-6">
                  Configure your chart settings and click "Generate Chart" to
                  visualize your data
                </p>
              </div>
            </div>
